  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/eco-friendly-consulting" element={<EcoFriendlyConsulting />} />
    <Route path="/green-technology-solutions" element={<GreenTechnologySolutions />} />
    <Route path="/environmental-impact-assessments" element={<EnvironmentalImpactAssessments />} />
    <Route path="/iso-certification-support" element={<IsoCertificationSupport />} />
    <Route path="/esg-integration-reporting" element={<EsgIntegrationReporting />} />
